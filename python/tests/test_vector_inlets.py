...
class TestVectorInlets(unittest.TestCase):
    def setUp(self):
        ...
        expected_output_path = Path(self.test_config["data_root"]) / "test_output.geojson"
        self.mock_delta_queue.delta_path.return_value = expected_output_path
    ...
    def test_overture_duckdb(self, mock_sql):
        ...
        # Call the function
        result = overture_duckdb(self.test_config, 'test_asset', self.mock_delta_queue)
