...
DEFAULT_ASSETS = {
    ...
    "webmap" : {
        "type": "outlet",
        "name": "webmap",
        "in_layers": ["basemap", "tsunami", "parcels", "roads", "milemarkers", "creeks", "buildings", "helilandings", "hydrants"],
        "config_def": "webmap",
